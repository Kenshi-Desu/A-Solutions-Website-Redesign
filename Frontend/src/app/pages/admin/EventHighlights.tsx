...
export default function EventHighlights() {
  ...
  const confirmDelete = async () => {
    ...
    await handleAdminDelete({
      ...
      successMessage: "Event highlight deleted successfully.",
    });
    setIsDeleting(false);
  ...
  const handleSave = async (
    ...
    >({
      ...
      updateItem,
      setIsSaving,
      successMessage: `Event Highlight ${isUpdate ? "updated" : "created"} successfully!`,
      onSuccess: () => setView("list"),
      buildPayload: (formData) => ({
        title: formData.get("title") as string,
        eventYear:
          Number(formData.get("eventYear")) || new Date().getFullYear(),
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-[#333333]">
              {editingItem ? "Edit Event Highlight" : "Add New Highlight"}
            </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2 space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="e.g., Grand Champion - 2024"
                    required
                  />
                </div>
      ...
      <Card className="shadow-sm border-gray-200 overflow-hidden">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center h-64 text-gray-500">
            ...
            <p className="text-lg font-medium">No event highlights found</p>
          </div>
        ) : (
          <Table>
            ...
            <TableBody>
              {events?.map((item) => (
                <TableRow key={item.id} className="hover:bg-gray-50/50">
                  <TableCell>
                    {item.imageUrl ? (
                      <div className="w-16 h-12 rounded bg-gray-100 border border-gray-200 overflow-hidden flex items-center justify-center">
                        <img
                          src={item.imageUrl}
                          alt={item.title}
                      ...
                      <div className="w-16 h-12 rounded bg-gray-100 border border-gray-200 flex items-center justify-center text-gray-400">
                        <ImageIcon size={20} />
                      </div>
                    )}
                  </TableCell>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1 pt-1">
                ...
                <p className="text-gray-600 text-sm mb-6 leading-relaxed">
                  Are you sure you want to completely remove this highlight?
