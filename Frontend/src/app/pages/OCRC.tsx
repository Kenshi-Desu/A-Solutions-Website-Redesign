...
export default function OCRC() {
  ...
  const galleryImages = [
    { title: 'Robot Competition', image: galleryImg1, color: 'from-[#6F67BA] to-[#5d57a0]' },
    { title: 'Team Collaboration', image: galleryImg2, color: 'from-[#E37F4E] to-[#d36e3d]' },
    { title: 'Award Ceremony', image: galleryImg3, color: 'from-[#6F67BA] to-[#E37F4E]' },
    { title: 'Innovation Showcase', image: galleryImg2, color: 'from-[#5d57a0] to-[#6F67BA]' },
    { title: 'Student Presentations', image: galleryImg1, color: 'from-[#d36e3d] to-[#E37F4E]' },
    { title: 'Judges Panel', image: galleryImg3, color: 'from-[#6F67BA] to-[#d36e3d]' },
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[500px] flex items-center justify-center overflow-hidden bg-[#2A3A53]">
        <div className="absolute inset-0">
          <ImageWithFallback src={heroImage} alt="OCRC Event" className="w-full h-full object-cover opacity-50" />
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-[#1f2937] rounded-xl p-8 text-center border border-[#6F67BA]/20 hover:border-[#6F67BA] transition-colors duration-300">
              ...
              <h3 className="text-2xl font-semibold text-white mb-2">Date & Time</h3>
            ...
            <div className="bg-[#1f2937] rounded-xl p-8 text-center border border-[#6F67BA]/20 hover:border-[#6F67BA] transition-colors duration-300">
              ...
              <h3 className="text-2xl font-semibold text-white mb-2">Eligibility</h3>
              <p className="text-gray-300">Elementary to High School</p>
              <p className="text-[#E37F4E] text-sm mt-1">Team of 3-5 students</p>
            </div>
          </div>
      ...
      <section className="py-20 bg-[#1f2937]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-white mt-2">OCRC Timeline</h2>
          </div>
      ...
      <section className="py-20 bg-[#2A3A53]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-white mt-2">Past Events Highlights</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {galleryImages.map((image, index) => (
              ...
              >
                <ImageWithFallback src={image.image} alt={image.title} className="absolute inset-0 w-full h-full object-cover mix-blend-overlay opacity-60 group-hover:opacity-80 transition-opacity duration-300" />
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-white font-semibold text-lg drop-shadow-md">{image.title}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-20 bg-[#1f2937]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-white mt-2">Our Partners & Sponsors</h2>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center mb-12 max-w-4xl mx-auto">
            {[
              ...
              >
                <ImageWithFallback src={sponsor.logo} alt={`${sponsor.name} logo`} className="w-full h-full object-contain mix-blend-multiply" />
              </div>
            ))}
          </div>
